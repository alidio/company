//Η κλάση αυτή αναλαμβάνει να ελέξει τη λείοτουργία των threads που 
//καταχωρούν τις άδειες. Επίσης ενημερώνει τα listbox της οθόνης με 
//τα αποτελέσματα της λειτουργίας τους.
package company;
